...
--
-- Name: serial; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--
...
ALTER TABLE public.serial OWNER TO freecodecamp;
...
--
-- Name: serial; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.serial', 3, true);
...
--
-- Name: elements elements_unique_constaint; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_unique_constaint UNIQUE (symbol, name);
